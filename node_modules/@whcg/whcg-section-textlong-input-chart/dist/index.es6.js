  ...
  static get template() {
    ...
    <div class="grid-12 categoryinputsection">
        ...
        <div class="col4span8 grid-8 categoryinputsection-content--withchartbottom">
            ...
            <div class="col1span2 categoryinputsection-content-inputbox">
                <slot name="input1"></slot>
            </div>
            <div class="col3span2 categoryinputsection-content-inputbox">
                <slot name="input2"></slot>
            </div>
            <div class="col5span2 categoryinputsection-content-inputbox">
                <slot name="input3"></slot>
            </div>
            <div class="col7span2 categoryinputsection-content-inputbox">
